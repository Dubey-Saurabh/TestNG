...
public class FirstAutomatedTest {
    ...
    public void testCheckboxDemo() {
        ...
        driver.findElement(By.xpath("//div[@class='mt-40']/label/input[@type='checkbox']")).click();
        String actualCheckboxText = driver.findElement(By.xpath("//p[text()='Checked!']")).getText();
        Assert.assertTrue(actualCheckboxText.contains("Checked!"), "Checkbox Demo Failed");
    }
    ...
    public void testRadioButtonsDemo() {
        ...
        softAssert.assertTrue(actualAge.contains("15"),"\n Age not matched \n");
